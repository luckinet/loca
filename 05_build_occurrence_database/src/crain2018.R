...
# features  : _INSERT
# data type : _INSERT
# doi/url   : https://doi.org/10.3835/plantgenome2017.05.0043
...
bib <- read.bib(file = paste0(dir_input, "pericles_1940337211.bib"))

# data_path_cmpr <- paste0(dir_input, "")
# unzip(exdir = dir_input, zipfile = data_path_cmpr)
# untar(exdir = dir_input, tarfile = data_path_cmpr)

data_path <- paste0(dir_input, "EYT_HTP_GS_Final/OriginalData/EYT_Plots.csv")
...
new_source(name = thisDataset,
           ...
           homepage = "https://doi.org/10.3835/plantgenome2017.05.0043",
           date = ymd("2022-04-13"),
           license = _INSERT,
