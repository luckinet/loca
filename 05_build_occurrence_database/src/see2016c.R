...
doi <- "https://doi.org/10.1594/PANGAEA.869662"
...
# reference ----
#
bib <- ris_reader(paste0(occurr_dir, "input/", thisDataset, "/", "Control_3.ris"))


# read dataset ----
#
data_path <- paste0(occurr_dir, "input/", thisDataset, "/", "Control_3.tab")
