...
# features  : _INSERT
# data type : _INSERT
# doi/url   : https://doi.org/10.1111/ecog.02637
...
bib <- read.bib(file = paste0(dir_input, "pericles_1600058741.bib"))

data_path <- paste0(dir_input, "observed CWM traits.csv")
data <- read_delim(file = data_path, delim = ";", n_max = 127)
...
new_source(name = thisDataset,
           ...
           homepage = "https://doi.org/10.1111/ecog.02637",
           date = ymd("2021-08-10"),
