...
# features  : _INSERT
# data type : _INSERT
# doi/url   : http://atlas-dwr.opendata.arcgis.com/datasets/f4f00986f1e141cc99cff221391084de_0/data
# authors   : Peter Pothmann, Steffen Ehrmann
# date      : 2024-MM-DD
# status    : find data, update, inventarize, validate, normalize, done
# comment   : needs a lot of work
# ----

thisDataset <- "californiaCrops"
message("\n---- ", thisDataset, " ----")
...
new_source(name = thisDataset,
           description = _INSERT,
           homepage = "http://atlas-dwr.opendata.arcgis.com/datasets/f4f00986f1e141cc99cff221391084de_0/data",
           date = ymd(_INSERT),
