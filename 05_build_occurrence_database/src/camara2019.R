...
# features  : _INSERT
# data type : _INSERT
# doi/url   : https://doi.org/10.1594/PANGAEA.899706
...
new_source(name = thisDataset,
           ...
           homepage = "https://doi.org/10.1594/PANGAEA.899706",
           date = ymd("2022-01-09"),
           license = _INSERT,
