...
lu <- list(
  ...
  tibble(concept = c("Shrub orchards", "Palm plantations", "Protective Cover", "Tree orchards", "Woody plantation"),
         description = c("Land covered by permanent cropland that is used to produce commodities that grow on shrubby vegetation",
                         ...
                         "Land covered by buildings that are used to produce plants, mushrooms or livestock under highly controlable conditions",
         ...
         fra = c(NA_character_, "3.1.1", NA_character_, "3.1.2", "1.2.1"),
         fao_lu = c("6650", "6650", "6649", "6650", "6650"),
         esa_lc = c("10 | 12 | 30 | 40", "10 | 12 | 30 | 40 | 50", "10 | 30 | 40 | 190", "10 | 12 | 30 | 40", "10 | 12 | 30 | 40"),
  ...
  tibble(concept = c("Agroforestry", "Mix of agricultural uses", "Mosaic of agricultural uses", "Mosaic of agriculture and natural vegetation"),
         description = c("Land covered by temporary cropland under the wooded cover of forestry species",
                         ...
                         "Land covered by small parcels of different agricultural uses",
                         "Land covered by small parcels of agricultural and (semi-)natural vegetation"),
         fra = c("3.1.3", NA_character_, NA_character_, NA_character_),
         fao_lu = c(NA_character_),
         esa_lc = c("10 | 20 | 30 | 40", "10 | 20 | 30 | 40", "10 | 20", "30 | 40"),
...
commodity <- list(
  ...
  tibble(concept = c("acacia", "black locust", "eucalyptus", "poplar", "willow"),
         ...
         use_typ = c("bioenergy"),
         used_part = c("biomass"),
         persistence = c("permanent"), lu_id = c()),
  ...
  tibble(concept = c("açaí", "avocado", "banana", "date", "fig", "guava", "mango", "mangosteen", "papaya", "persimmon", "pineapple", "plantain"),
         ...
         life_form = c("palm", "tree", "tree", "palm", "shrub", "tree", "tree", "tree", "tree", "tree", "shrub", "tree"),
  ...
  tibble(concept = c("bambara bean", "common bean", "broad bean", "carob", "chickpea", "cow pea", "lentil", "pea", "pigeon pea", "vetch"),
         ...
         used_part = c("seed"),
         persistence = c("temporary", "temporary", "temporary", "permanent", "temporary", "temporary",
                         "temporary", "temporary", "temporary", "temporary"),
         lu_id = c(rep("2 | 11 | 12 | 13 | 14", 3), "7 | 11 | 12 | 13 | 14", rep("2 | 11 | 12 | 13 | 14", 6))),
  ...
  tibble(concept = c("castor bean", "cotton", "earth pea", "fenugreek", "hemp", "linseed", "jojoba", "mustard", "niger seed", "peanut | goundnut", "poppy", "rapeseed | colza", "safflower", "sesame", "shea nut | karite nut", "soybean", "sunflower", "tallowtree", "tung nut"),
         ...
         persistence = c("temporary", "permanent", "temporary", "temporary", "temporary", "temporary",
                         "temporary", "temporary", "temporary", "temporary", "temporary", "temporary",
                         "temporary", "temporary", "permanent", "temporary", "temporary", "permanent",
                         "permanent"), lu_id = c()),
  tibble(concept = c("cocoa | cacao", "coffee", "mate", "tea", "tobacco"),
         ...
         persistence = c("permanent", "permanent", "permanent", "permanent", "temporary"), lu_id = c()),
  tibble(concept = c("anise", "badian | star anise", "cannella cinnamon", "caraway", "cardamon", "chillies and peppers", "clove", "coriander",
         ...
         icc_11 = c("6.02.01.02", "6.02.01.02", "6.02.02.03", "6.02.01.90", "6.02.02.02", "6.02.01.01", "6.02.02.04", "6.02.01.02", "6.02.01.02", "6.02.01.02", "6.02.02.90", "6.02.02.05", "6.02.02.07", "6.02.01.02", "6.02.02.02", "6.02.02.02", "6.02.02.02", "6.02.02.01", "6.02.02.90", "6.02.02.06", "9.03.01"),
         cpc_21 = c("01654", "01654", "01655", "01654", "01653", "01652 | 01231", "01656", "01654", "01654", "0169", "01654", "01657", "01659", "01654", "01653", "01653", "01653", "01651", "0169", "01658", "01699"),
         scientific_name = c("Pimpinella anisum", "Illicium verum", "Cinnamomum verum", "Carum carvi", "Elettaria cardamomum", "Capsicum spp.", "Eugenia aromatica", "Coriandrum sativum", "Cuminum cyminum", "Anethum graveoles", "Foeniculum vulgare", "Zingiber officinale", "Humulus lupulus", "Juniperus communis", "Myristica fragrans", "Aframomum melegueta", "Myristica fragrans", "Piper nigrum", "Thymus vulgaris", "Vanilla planifolia", "Lavandula spp."),
         wiki_id = c("Q28692", "Q1760637", "Q28165 | Q370239", "Q26811", "Q14625808", "Q165199 | Q201959 | Q1380", "Q15622897", "Q41611 | Q20856764", "Q57328174 | Q132624", "Q26686 | Q59659860", "Q43511 | Q27658833", "Q35625 | Q15046077", "Q104212", "Q3251025", "Q1882876", "Q3312331", "Q12104", "Q311426", "Q148668 | Q3215980", "Q162044", "Q42081"),
         life_form = c("forb", "forb", "forb", "forb", "forb", "forb", "tree", "forb", "forb", "forb", "forb", "forb", "forb", "shrub", "tree", "forb", "tree", "forb", "forb", "forb", "forb"),
         use_typ = c("food", "food", "food", "food", "food", "food", "food", "food", "food", "food", "food", "food", "food", "food", "food | fibre", "food", "food", "food", "food", "food", "food"),
         used_part = c("fruit", "fruit", "bark", "seed", "seed", "fruit", "flower", "seed | leaves", "seed", "seed", "bulb | leaves | fruit", "root", "flower", "fruit", "fruit", "fruit", "seed", "fruit", "seed", "fruit", "leaves"),
         persistence = c("temporary", "temporary", "permanent", "temporary", "permanent", "temporary",
                         "permanent", "temporary", "temporary", "temporary", "temporary", "permanent",
                         "permanent", "permanent", "permanent", "temporary", "permanent", "permanent",
                         "temporary", "permanent", "permanent"), lu_id = c()),
  tibble(concept = c("basil", "coca", "ginseng", "guarana", "kava", "liquorice", "mint"),
         ...
         persistence = c("temporary"),
         lu_id = c("2 | 6 | 11 | 12 | 13 | 14", "7 | 11 | 12 | 13 | 14", rep("2 | 6 | 11 | 12 | 13 | 14", 5))),
  ...
  tibble(concept = c("sugar cane", "sweet sorghum", "sugar maple"),
         ...
         persistence = c("temporary"),
         lu_id = c(rep("2 | 11 | 12 | 13 | 14", 2), "7 | 8 | 12 | 13")),
  ...
  tibble(concept = c("carrot", "chive", "beet root | red beet", "chard", "garlic", "leek", "onion", "turnip",
         ...
         scientific_name = c("Daucus carota ssp. sativa", "Allium schoenoprasum", "Beta vulgaris var. vulgaris", "Beta vulgaris var. cicla", "Allium sativum", "Allium ampeloprasum | Allium porrum", "Allium cepa", "Brassica rapa", "Beta vulgaris var. crassa", "Manihot esculenta", "Solamum tuberosum", "Ipomoea batatas", "Colocasia esculenta", "Dioscorea spp.", "Xanthosoma sagittifolium"),
         wiki_id = c("Q81 | Q11678009", "Q5766863", "Q99548274", "Q157954", "Q23400 | Q21546392", "Q1807269", "Q13191", "Q3916957 | Q3384", "Q740726", "Q43304555 | Q83124", "Q16587531 | Q10998", "Q37937", "Q227997", "Q8047551 | Q71549", "Q763075"),
         life_form = c("forb"),
         use_typ = c("food | fodder", "food", "food", "food", "food", "food", "food", "food", "food | forage", "food", "food", "food", "food", "food", "food"),
