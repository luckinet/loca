...
lc <- list(
  ...
  tibble(concept = c("Temporary cropland", "Pastures", "Permanent cropland", "Agroforestry systems"),
         description = c("Lands under a rotation system used for annually harvested plants and fallow lands, which are rain-fed or irrigated. Includes flooded crops such as rice fields and other inundated croplands",
                         ...
                         "Lands under ", "Areas of annual crops associated with permanent crops on the same parcel, annual crops cultivated under forest trees, areas of annual crops, meadows and/or permanent crops which are juxtaposed, landscapes in which crops and pastures are intimately mixed with natural vegetation or natural areas"),
...
lu <- list(
  ...
  tibble(concept = c("Agroforestry", "Mix of agricultural uses"), continue here (sort in agroforestry above and make more distinctions here )
