...
#
# todo:
#   update all look up tables by finding unique elements in 'commodities' after finishing it
...
luckiOnto <- new_source(name = "age-max",
                        date = Sys.Date(),
                        description = "the maximum number of months a an animal would have when it is associated to a certain age type.",
                        homepage = "",
                        license = "CC-BY-4.0",
                        ontology = luckiOnto)
...
#                         date = Sys.Date(),
#                         description = "the number of years in a row the crop can be harvested",
#                         homepage = "",
#                         license = "CC-BY-4.0",
#                         ontology = luckiOnto)
...
# here, each item has the following variables
...
#                age_max = integer(),       the maximum number of months, typically of an age class of livestock
...
bioenergy <-
  tibble(concept = "bamboo", broader = class$concept[1], scientific = "Bambusa spp.",
         ...
         use_type = useTypes$label[1], age_max = NA_character_, used_part = usedParts$label[1], life_form = "graminoid",
...
bioenergy <-
  tibble(concept = "acacia", broader = class$concept[1], scientific = "Acacia spp.",
         ...
         use_type = useTypes$label[1], age_max = NA_character_, used_part = usedParts$label[1], life_form = "tree",
...
fibre <-
  tibble(concept = "jute", broader = class$concept[2], scientific = "Corchorus spp.",
         ...
         use_type = useTypes$label[2], age_max = NA_character_, used_part = usedParts$label[2], life_form = "forb",
...
fibre <-
  tibble(concept = "abaca | manila hemp", broader = class$concept[2], scientific = "Musa textilis",
         ...
         use_type = useTypes$label[2], age_max = NA_character_, used_part = usedParts$label[3], life_form = "tree",
...
fibre <-
  tibble(concept = "kapok", broader = class$concept[2], scientific = "Ceiba pentandra",
         ...
         use_type = "fibre | food", age_max = NA_character_, used_part = usedParts$label[4], life_form = "tree",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(fibre, .)
...
fibre <-
  tibble(concept = "new zealand flax | formio", broader = class$concept[2], scientific = "Phormium tenax",
         ...
         use_type = "fibre", age_max = NA_character_, used_part = "stalk", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(fibre, .)
...
fibre <-
  tibble(concept = "fique", broader = class$concept[2], scientific = "Furcraea macrophylla",
         ...
         use_type = "fibre", age_max = NA_character_, used_part = "leaves", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(fibre, .)
...
fibre <-
  tibble(concept = "henequen", broader = class$concept[2], scientific = "Agave fourcroydes",
         ...
         use_type = "fibre", age_max = NA_character_, used_part = "leaves | food", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(fibre, .)
...
rubber <-
  tibble(concept = "natural rubber", broader = class$concept[4], scientific = "Hevea brasiliensis",
         ...
         use_type = "industrial", age_max = NA_character_, used_part = "resin", life_form = "tree",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA)
...
pasture <-
  tibble(concept = "alfalfa", broader = class$concept[5], scientific = "Medicago sativa",
         ...
         use_type = "food | fodder | forage", age_max = NA_character_, used_part = "biomass", life_form = "graminoid",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA)
...
pasture <-
  tibble(concept = "orchard grass", broader = class$concept[5], scientific = "Dactylis glomerata",
         ...
         use_type = "fodder | forage", age_max = NA_character_, used_part = "biomass", life_form = "graminoid",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(pasture, .)
...
pasture <-
  tibble(concept = "redtop", broader = class$concept[5], scientific = "Agrostis spp.",
         ...
         use_type = "forage", age_max = NA_character_, used_part = "biomass", life_form = "graminoid",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(pasture, .)
...
pasture <-
  tibble(concept = "sudan grass", broader = class$concept[5], scientific = "Sorghum × drummondii",
         ...
         use_type = "fodder | energy", age_max = NA_character_, used_part = "biomass", life_form = "graminoid",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(pasture, .)
...
pasture <-
  tibble(concept = "timothy", broader = class$concept[5], scientific = "Phleum pratense",
         ...
         use_type = "fodder", age_max = NA_character_, used_part = "biomass", life_form = "graminoid",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(pasture, .)
...
pasture <-
  tibble(concept = "clover", broader = class$concept[5], scientific = "Trifolium spp.",
         ...
         use_type = "fodder | forage", age_max = NA_character_, used_part = "biomass", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(pasture, .)
...
pasture <-
  tibble(concept = "lupin", broader = class$concept[5], scientific = "Lupinus spp.",
         ...
         use_type = "fodder | forage | food", age_max = NA_character_, used_part = "biomass", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(pasture, .)
...
berries <-
  tibble(concept = "blueberry", broader = class$concept[6], scientific = "Vaccinium myrtillus | Vaccinium corymbosum",
         ...
         use_type = "food", age_max = NA_character_, used_part = "fruit", life_form = "shrub",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA)
...
berries <-
  tibble(concept = "raspberry", broader = class$concept[6], scientific = "Rubus spp.",
         ...
         gbif_id = "2988638", use_type = "food", age_max = NA_character_, used_part = "fruit", life_form = "shrub",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(berries, .)
...
citrus <-
  tibble(concept = "bergamot", broader = class$concept[7], scientific = "Citrus bergamia",
         ...
         use_type = "food", age_max = NA_character_, used_part = "fruit", life_form = "tree",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA)
...
oleaginous <-
  tibble(concept = "coconut", broader = class$concept[11], scientific = "Cocos nucifera",
         ...
         use_type = "food | fibre", age_max = NA_character_, used_part = "seed | husk", life_form = "palm",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA)
...
oleaginous <-
  tibble(concept = "oil palm", broader = class$concept[11], scientific = "Elaeis guineensis",
         ...
         use_type = "food", age_max = NA_character_, used_part = "seed", life_form = "palm",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
...
tropical <-
  tibble(concept = "banana", broader = class$concept[12], scientific = "Musa sapientum | Musa cavendishii | Musa nana",
         ...
         use_type = "fibre | food", age_max = NA_character_, used_part = "fruit", life_form = "tree",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(tropical, .)
...
tropical <-
  tibble(concept = "açaí", broader = class$concept[12], scientific = "Euterpe oleracea",
         ...
         use_type = "food", age_max = NA_character_, used_part = "fruit", life_form = "palm",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(tropical, .)
...
cereals <-
  tibble(concept = "barley", broader = class$concept[13], scientific = "Hordeum vulgare",
         ...
         use_type = "forage | food", age_max = NA_character_, used_part = "seed", life_form = "graminoid",
...
cereals <-
  tibble(concept = "maize", broader = class$concept[13], scientific = "Zea mays",
         ...
         use_type = "food | silage", age_max = NA_character_, used_part = "seed", life_form = "graminoid",
         ybh = 0, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(cereals, .)
...
cereals <-
  tibble(concept = "pearl millet", broader = class$concept[13], scientific = "Cenchrus americanus",
         ...
         use_type = "food", age_max = NA_character_, used_part = "seed", life_form = "graminoid",
         ybh = 0, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(cereals, .)
...
cereals <-
  tibble(concept = "oat", broader = class$concept[13], scientific = "Avena sativa",
         ...
         use_type = "food | fodder", age_max = NA_character_, used_part = "seed", life_form = "graminoid",
         ybh = 0, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(cereals, .)
...
legumes <-
  tibble(concept = "bambara bean", broader = class$concept[14], scientific = "Vigna subterranea",
         ...
         use_type = "food", age_max = NA_character_, used_part = "seed", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA)
...
legumes <-
  tibble(concept = "vetch", broader = class$concept[14], scientific = "Vicia sativa",
         ...
         use_type = "food | fodder", age_max = NA_character_, used_part = "seed", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(legumes, .)
...
legumes <-
  tibble(concept = "carob", broader = class$concept[14], scientific = "Ceratonia siliqua",
         ...
         use_type = "food", age_max = NA_character_, used_part = "seed", life_form = "tree",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(legumes, .)
...
oilseeds <-
  tibble(concept = "castor bean", broader = class$concept[16], scientific = "Ricinus communis",
         ...
         use_type = "medicinal | food", age_max = NA_character_, used_part = "seed", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA)
...
oilseeds <-
  tibble(concept = "cotton", broader = class$concept[16], scientific = "Gossypium spp.",
         ...
         use_type = "food | fibre", age_max = NA_character_, used_part = "fruit | husk", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(oilseeds, .)
...
oilseeds <-
  tibble(concept = "earth pea", broader = class$concept[16], scientific = "Vigna subterranea",
         ...
         use_type = "food", age_max = NA_character_, used_part = "fruit", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(oilseeds, .)
...
oilseeds <-
  tibble(concept = "fenugreek", broader = class$concept[16], scientific = "Trigonella foenum-graecum",
         ...
         use_type = "food", age_max = NA_character_, used_part = "seed | leaves", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(oilseeds, .)
...
oilseeds <-
  tibble(concept = "hemp", broader = class$concept[16], scientific = "Canabis sativa",
         ...
         use_type = "food | fibre", age_max = NA_character_, used_part = "seed | lint", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(oilseeds, .)
...
oilseeds <-
  tibble(concept = "linseed", broader = class$concept[16], scientific = "Linum usitatissimum",
         ...
         use_type = "food | fibre | industrial", age_max = NA_character_, used_part = "seed", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(oilseeds, .)
...
oilseeds <-
  tibble(concept = "jojoba", broader = class$concept[16], scientific = "Simmondsia chinensis",
         ...
         use_type = "food", age_max = NA_character_, used_part = "seed | bast | seed", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(oilseeds, .)
...
oilseeds <-
  tibble(concept = "poppy", broader = class$concept[16], scientific = "Papaver somniferum",
         ...
         use_type = "food | medicinal | recreation", age_max = NA_character_, used_part = "seed", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(oilseeds, .)
...
oilseeds <-
  tibble(concept = "safflower", broader = class$concept[16], scientific = "Carthamus tinctorius",
         ...
         use_type = "food | industrial", age_max = NA_character_, used_part = "seed", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(oilseeds, .)
...
oilseeds <-
  tibble(concept = "tallowtree", broader = class$concept[16], scientific = "Shorea aptera | Shorea stenocarpa | Sapium sebiferum",
         ...
         use_type = "industrial", age_max = NA_character_, used_part = "seed", life_form = "tree",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(oilseeds, .)
...
stimulants <-
  tibble(concept = "tobacco", broader = class$concept[17], scientific = "Nicotiana tabacum",
         ...
         use_type = "recreation", age_max = NA_character_, used_part = "leaves", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA)
...
stimulants <-
  tibble(concept = "cocoa | cacao", broader = class$concept[17], scientific = "Theobroma cacao",
         ...
         use_type = "food | recreation", age_max = NA_character_, used_part = "seed", life_form = "tree",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
...
stimulants <-
  tibble(concept = "coffee", broader = class$concept[17], scientific = "Coffea spp.",
         ...
         use_type = "food | recreation", age_max = NA_character_, used_part = "fruit", life_form = "shrub",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(stimulants, .)
...
stimulants <-
  tibble(concept = "mate", broader = class$concept[17], scientific = "Ilex paraguariensis",
         ...
         use_type = "food | recreation", age_max = NA_character_, used_part = "leaves", life_form = "shrub",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(stimulants, .)
...
spice <-
  tibble(concept = "cannella cinnamon", broader = class$concept[18], scientific = "Cinnamomum verum",
         ...
         use_type = "food | medicinal", age_max = NA_character_, used_part = "bark", life_form = "tree",
...
spice <-
  tibble(concept = "chillies and peppers", broader = class$concept[18], scientific = "Capsicum spp.",
         ...
         use_type = "food | medicinal", age_max = NA_character_, used_part = "fruit", life_form = "forb",
...
spice <-
  tibble(concept = "fennel", broader = class$concept[18], scientific = "Foeniculum vulgare",
         ...
         use_type = "food", age_max = NA_character_, used_part = "bulb | leaves | fruit", life_form = "forb",
         ybh = 0, yoh = 1, harvests = 1,  yield_min = NA, yield_max = NA, height = 2) %>%
  bind_rows(spice, .)
...
spice <-
  tibble(concept = "hop", broader = class$concept[18], scientific = "Humulus lupulus",
         ...
         use_type = "food", age_max = NA_character_, used_part = "flower", life_form = "vine",
...
spice <-
  tibble(concept = "ginger", broader = class$concept[18], scientific = "Zingiber officinale",
         ...
         use_type = "food", age_max = NA_character_, used_part = "root", life_form = "forb",
...
spice <-
  tibble(concept = "vanilla", broader = class$concept[18], scientific = "Vanilla planifolia",
         ...
         use_type = "food", age_max = NA_character_, used_part = "fruit", life_form = "vine",
...
spice <-
  tibble(concept = "lavender", broader = class$concept[18], scientific = "Lavandula spp.",
         ...
         use_type = "food", age_max = NA_character_, used_part = "leaves | buds", life_form = "forb",
         ybh = 0, yoh = 1, harvests = 1,  yield_min = NA, yield_max = NA, height = 1) %>%
  bind_rows(spice, .)
...
spice <-
  tibble(concept = "angelica", broader = class$concept[18], scientific = "Angelica archangelica",
         ...
         use_type = "food | medicinal", age_max = NA_character_, used_part = "shoot", life_form = "forb",
...
spice <-
  tibble(concept = "bay leaves", broader = class$concept[18], scientific = "Laurus nobilis",
         ...
         use_type = "food | medicinal", age_max = NA_character_, used_part = "leaves", life_form = "tree",
...
spice <-
  tibble(concept = "saffron", broader = class$concept[18], scientific = "Crocus sativus",
         ...
         use_type = "food", age_max = NA_character_, used_part = "flower", life_form = "forb",
         ybh = 0, yoh = 1, harvests = 1,  yield_min = NA, yield_max = NA, height = 0.5) %>%
  bind_rows(spice, .)
...
spice <-
  tibble(concept = "turmeric", broader = class$concept[18], scientific = "Curcuma longa",
         ...
         use_type = "food | medicinal", age_max = NA_character_, used_part = "root", life_form = "forb",
         ybh = 0, yoh = 1, harvests = 1,  yield_min = NA, yield_max = NA, height = 1) %>%
  bind_rows(spice, .)
...
spice <-
  tibble(concept = "clove", broader = class$concept[18], scientific = "Eugenia aromatica",
         ...
         use_type = "food", age_max = NA_character_, used_part = "flower", life_form = "tree",
...
medicinal <-
  tibble(concept = "basil", broader = class$concept[19], scientific = "Ocimum basilicum",
         ...
         use_type = "food", age_max = NA_character_, used_part = "leaves", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA)
...
medicinal <-
  tibble(concept = "guarana", broader = class$concept[19], scientific = "Paulinia cupana",
         ...
         use_type = "food | recreation", age_max = NA_character_, used_part = "seed", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(medicinal, .)
...
medicinal <-
  tibble(concept = "coca", broader = class$concept[19], scientific = "Erythroxylum novogranatense | Erythroxylum coca",
         ...
         use_type = "recreation", age_max = NA_character_, used_part = "leaves", life_form = "tree",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(medicinal, .)
...
sugar <-
  tibble(concept = "sugar beet", broader = class$concept[20], scientific = "Beta vulgaris var. altissima",
         ...
         use_type = "food | fodder", age_max = NA_character_, used_part = "root", life_form = "forb",
...
sugar <-
  tibble(concept = "sugar cane", broader = class$concept[20], scientific = "Saccharum officinarum",
         ...
         use_type = "food | fodder", age_max = NA_character_, used_part = "shoot | sap", life_form = "graminoid",
...
sugar <-
  tibble(concept = "sweet sorghum", broader = class$concept[20], scientific = "Sorghum saccharatum",
         ...
         use_type = "food | fodder | energy", age_max = NA_character_, used_part = "shoot | sap", life_form = "graminoid",
...
sugar <-
  tibble(concept = "sugar maple", broader = class$concept[20], scientific = "Acer saccharum",
         ...
         use_type = "food", age_max = NA_character_, used_part = "sap", life_form = "tree",
...
fruit_veg <-
  tibble(concept = "pumpkin", broader = class$concept[21], scientific = "Cucurbita spp",
         ...
         use_type = "food | fodder", age_max = NA_character_, used_part = "fruit", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(fruit_veg, .)
...
leaf_veg <-
  tibble(concept = "asparagus", broader = class$concept[22], scientific = "Asparagus officinalis",
         ...
         use_type = "food", age_max = NA_character_, used_part = "shoots", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(leaf_veg, .)
...
leaf_veg <-
  tibble(concept = "bok choy | pak choi", broader = class$concept[22], scientific = "Brassica rapa subsp. chinensis",
         ...
         use_type = "fodder | food", age_max = NA_character_, used_part = "leaves", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(leaf_veg, .)
...
leaf_veg <-
  tibble(concept = "brussels sprout", broader = class$concept[22], scientific = "Brassica oleracea var. gemmifera",
         ...
         use_type = "fodder | food", age_max = NA_character_, used_part = "flower", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(leaf_veg, .)
...
leaf_veg <-
  tibble(concept = "cabbage", broader = class$concept[22], scientific = "Brassica oleracea var. capitata",
         ...
         use_type = "food | fodder", age_max = NA_character_, used_part = "leaves", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(leaf_veg, .)
...
leaf_veg <-
  tibble(concept = "chicory", broader = class$concept[22], scientific = "Cichorium intybus",
         ...
         use_type = "food | recreation", age_max = NA_character_, used_part = "leaves", life_form = "forb",
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(leaf_veg, .)
...
mushrooms <-
  tibble(concept = "mushrooms", broader = class$concept[23], scientific = "Agaricus spp. | Pleurotus spp. | Volvariella",
         ...
         use_type = useTypes$label[3], age_max = NA_character_, used_part = usedParts$label[5], life_form = "mushroom",
...
root_veg <-
  tibble(concept = "beet root | red beet", broader = class$concept[24], scientific = "Beta vulgaris subsp. vulgaris conditiva group",
         ...
         use_type = "food | fodder | medicinal", age_max = NA_character_, used_part = "leaves", life_form = "forb",
         ybh = 0, yoh = 1, harvests = 1,  yield_min = NA, yield_max = NA, height = 0.5) %>%
  bind_rows(root_veg, .)
...
root_veg <-
  tibble(concept = "garlic", broader = class$concept[24], scientific = "Allium sativum",
         ...
         use_type = "food", age_max = NA_character_, used_part = "bulb", life_form = "forb",
         ybh = 0, yoh = 1, harvests = 1,  yield_min = NA, yield_max = NA, height = 1) %>%
  bind_rows(root_veg, .)
...
root_veg <-
  tibble(concept = "mangelwurzel", broader = class$concept[24], scientific = "Beta vulgaris subsp. vulgaris crassa group",
         ...
         use_type = "food | forage", age_max = NA_character_, used_part = "root", life_form = "forb",
         ybh = 0, yoh = 1, harvests = 1,  yield_min = NA, yield_max = NA, height = 0.5) %>%
  bind_rows(root_veg, .)
...
root_veg <-
  tibble(concept = "manioc | cassava | tapioca", broader = class$concept[24], scientific = "Manihot esculenta",
         ...
         use_type = "food | fodder", age_max = NA_character_, used_part = "tuber", life_form = "shrub",
...
root_veg <-
  tibble(concept = "sweet potato", broader = class$concept[24], scientific = "Ipomoea batatas",
         ...
         use_type = "food", age_max = NA_character_, used_part = "tuber", life_form = "forb",
         ybh = 0, yoh = 1, harvests = 1,  yield_min = NA, yield_max = NA, height = 0.5) %>%
  bind_rows(root_veg, .)
...
root_veg <-
  tibble(concept = "yam", broader = class$concept[24], scientific = "Dioscorea spp.",
         ...
         use_type = "food", age_max = NA_character_, used_part = "tuber", life_form = "vine",
...
root_veg <-
  tibble(concept = "yautia", broader = class$concept[24], scientific = "Xanthosoma sagittifolium",
         ...
         use_type = "food | fodder", age_max = NA_character_, used_part = "tuber", life_form = "forb",
         ybh = 0, yoh = 1, harvests = 1,  yield_min = NA, yield_max = NA, height = 2) %>%
  bind_rows(root_veg, .)
...
animals <-
  tibble(concept = "pigeon", broader = class$concept[25], scientific = "Columba livia",
         ...
         use_type = "labor | food", age_max = NA_character_, used_part = "time | eggs | meat", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(animals, .)
...
animals <-
  tibble(concept = "hare", broader = class$concept[26], scientific = "Lepus spp.",
         ...
         use_type = "food", age_max = NA_character_, used_part = "meat", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(animals, .)
...
animals <-
  tibble(concept = "buffalo", broader = class$concept[28], scientific = "Bubalus bubalus | Bubalus ami | Bubalus depressicornis | Bubalus nanus | Syncerus spp. | Bison spp.",
         ...
         use_type = "labor | food", age_max = NA_character_, used_part = "time | milk | meat", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(animals, .)
...
animals <-
  tibble(concept = "alpaca", broader = class$concept[30], scientific = "Vicugna pacos",
         ...
         use_type = "fibre", age_max = NA_character_, used_part = "hair", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(animals, .)
...
animals <-
  tibble(concept = "camel", broader = class$concept[30], scientific = "Camelus bactrianus | Camelus dromedarius",
         ...
         use_type = "labor", age_max = NA_character_, used_part = "time", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(animals, .)
...
animals <-
  tibble(concept = "llama", broader = class$concept[30], scientific = "Lama glama",
         ...
         use_type = "fibre | labor", age_max = NA_character_, used_part = "hair | time", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(animals, .)
...
animals <-
  tibble(concept = "ass", broader = class$concept[31], scientific = "Equus asinus",
         ...
         use_type = "labor | food", age_max = NA_character_, used_part = "time | meat", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(animals, .)
...
animals <-
  tibble(concept = "beehive", broader = class$concept[33], scientific = "Apis mellifera | Apis dorsata | Apis florea | Apis indica",
         ...
         use_type = "labor | food", age_max = NA_character_, used_part = "honey", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(animals, .)
...
### animal age and sex classes ----
animalAge <-
  tibble(concept = "calf", broader = animals$concept[11], scientific = "",
         icc_id = NA_character_, cpc_id = "", wiki_id = "", gbif_id = "",
         use_type = "", age_class = "0-6", used_part = "", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA)

animalAge <-
  tibble(concept = "steer | heifer _young", broader = animals$concept[11], scientific = "",
         icc_id = NA_character_, cpc_id = "", wiki_id = "", gbif_id = "",
         use_type = "", age_class = "6-12", used_part = "", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(animalAge, .)

animalAge <-
  tibble(concept = "steer | heifer _adolescent", broader = animals$concept[11], scientific = "",
         icc_id = NA_character_, cpc_id = "", wiki_id = "", gbif_id = "",
         use_type = "", age_class = "12-24", used_part = "", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(animalAge, .)

animalAge <-
  tibble(concept = "steer | heifer _adult", broader = animals$concept[11], scientific = "",
         icc_id = NA_character_, cpc_id = "", wiki_id = "", gbif_id = "",
         use_type = "", age_class = "> 24", used_part = "", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(animalAge, .)

animalAge <-
  tibble(concept = "cow", broader = animals$concept[11], scientific = "",
         icc_id = NA_character_, cpc_id = "", wiki_id = "", gbif_id = "",
         use_type = "", age_class = "> 24", used_part = "", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(animalAge, .)
...
animalAge <-
  tibble(concept = "bull", broader = animals$concept[11], scientific = "",
         icc_id = NA_character_, cpc_id = "", wiki_id = "", gbif_id = "",
         use_type = "", age_class = "> 24", used_part = "", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(animalAge, .)
...
animalAge <-
  tibble(concept = "kid", broader = animals$concept[12], scientific = "",
         icc_id = NA_character_, cpc_id = "", wiki_id = "", gbif_id = "",
         use_type = "", age_max = 12, used_part = "", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(animalAge, .)

animalAge <-
  tibble(concept = "nanny", broader = animals$concept[12], scientific = "",
         icc_id = NA_character_, cpc_id = "", wiki_id = "", gbif_id = "",
         use_type = "", age_max = NA_character_, used_part = "", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(animalAge, .)

animalAge <-
  tibble(concept = "billy", broader = animals$concept[12], scientific = "",
         icc_id = NA_character_, cpc_id = "", wiki_id = "", gbif_id = "",
         use_type = "", age_max = NA_character_, used_part = "", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(animalAge, .)
...
animalAge <-
  tibble(concept = "lamb", broader = animals$concept[13], scientific = "",
         icc_id = NA_character_, cpc_id = "", wiki_id = "", gbif_id = "",
         use_type = "", age_max = 6, used_part = "", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(animalAge, .)

animalAge <-
  tibble(concept = "ewe", broader = animals$concept[13], scientific = "",
         icc_id = NA_character_, cpc_id = "", wiki_id = "", gbif_id = "",
         use_type = "", age_max = NA_character_, used_part = "", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(animalAge, .)
...
animalAge <-
  tibble(concept = "ram", broader = animals$concept[13], scientific = "",
         icc_id = NA_character_, cpc_id = "", wiki_id = "", gbif_id = "",
         use_type = "", age_max = NA_character_, used_part = "", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(animalAge, .)
...
animalAge <-
  tibble(concept = "", broader = animals$concept[], scientific = "",
         icc_id = NA_character_, cpc_id = "", wiki_id = "", gbif_id = "",
         use_type = "", age_max = NA_character_, used_part = "", life_form = NA_character_,
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(animalAge, .)
...
#                          target = left_join(commodity %>% select(label = concept, age_max), get_concept(label = commodity$concept, ontology = luckiOnto), by = "label") %>% select(id, label, class, has_broader),
