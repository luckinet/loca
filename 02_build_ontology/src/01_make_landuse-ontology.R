...
commodity <- list(
  ...
  #        broader = class$concept[11],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  # tibble(concept = c("clover", "lupin"),
  #        broader = class$concept[12],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  # tibble(concept = c("blueberry", "cranberry", "currant", "gooseberry", "kiwi fruit", "raspberry", "strawberry"),
  #        broader = class$concept[14],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  # tibble(concept = c("clementine", "grapefruit", "lemon", "lime", "mandarine", "orange", "pomelo", "satsuma", "tangerine"),
  #        broader = class$concept[15],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  # tibble(concept = c("grape"),
  #        broader = class$concept[16],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  ...
  #        broader = class$concept[18],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  # tibble(concept = c("açaí", "avocado", "banana", "date", "fig", "guava", "mango", "mangosteen", "papaya", "persimmon", "pineapple", "plantain"),
  #        broader = class$concept[19],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  # tibble(concept = c("natural gums", "natural rubber"),
  #        broader = class$concept[21],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  # tibble(concept = c("basil", "coca", "ginseng", "guarana", "kava", "mint", "peppermint", "tobacco"),
  #        broader = class$concept[23],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  ...
  #        broader = class$concept[26],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  # tibble(concept = c("bambara bean", "bean", "broad bean", "carob", "chickpea", "cow pea", "lentil", "pea", "pigeon pea", "string bean", "vetch"),
  #        broader = class$concept[27],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  # tibble(concept = c("almond", "areca nut", "brazil nut", "cashew", "chestnut", "hazelnut", "kolanut", "pistachio", "walnut"),
  #        broader = class$concept[28],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  # tibble(concept = c("castor bean", "coconut", "hempseed", "linseed", jojoba", "linseed", "mustard", "niger seed", "oil palm", "olive", "peanut", "poppy", "rapeseed", "safflower", "sesame", "shea nut", "soybean", "sunflower", "tallowtree", "tung nut"),
  #        broader = class$concept[29],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  # tibble(concept = c("cocoa beans", "coffee", "mate", "tea"),
  #        broader = class$concept[31],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  ...
  #        broader = class$concept[32],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  # tibble(concept = c("stevia"),
  #        broader = class$concept[34],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  # tibble(concept = c("sugar beet"),
  #        broader = class$concept[35],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  # tibble(concept = c("sugar cane"),
  #        broader = class$concept[36],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  # tibble(concept = c("cantaloupe", "cucumber", "eggplant", "gherkin", "gourd", "melon", "okra", "pumpkin", "squash", "tomato", "watermelon"),
  #        broader = class$concept[38],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  ...
  #        broader = class$concept[39],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  # tibble(concept = c("mushrooms"),
  #        broader = class$concept[40],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
  # tibble(concept = c("carrot", "chive", "garlic", "leek", "onion", "turnip", "cassava", "potato", "sweet potato", "taro", "yam", "yautia"),
  #        broader = class$concept[41],          icc_11 = c(), cpc_21 = c(), scientific_name = c(),          wiki_id = c(),          life_form = c(),          use_typ = c(),          persistence = c()),
