...
ld <- tribble(
  ...
  "Seasonal flooding",  "Areas that are terrestrial but are inundated seasonaly (several months, but not the whole year).", lc$concept[4],
  "Permanent flooding", "Areas that are terrestrial but are inundated permanently (several years or decades).", lc$concept[4],
...
lu <- tribble(
  ...
  "Artificial built-up land",        "Areas that are artificial and non-productive with built-up structures such as buildings, roads and rails that exlude primary sector uses.", ld$concept[2],
  "Energy production",               "Areas that are artificial and non-productive with structures that are used for energy production that exlude primary sector uses.", ld$concept[2],
  ...
  "Unmanaged pastures",              "Areas with herbaceous vegetation with permanent use for grazing that is unmanaged (with occasional woody vegetation).", ld$concept[5],
  "Fallow",                          "Areas with herbaceous vegetation where currently nothing is extracted (at most for 3 years).", ld$concept[5],
  "Natural herbaceous vegetation",   "Areas with herbaceous vegetation associations that are unmanaged and without deliberate use.", ld$concept[5],
  "Shrub orchards",                  "Areas with woody vegetation used to produce commodities that grow on shrubs.", ld$concept[6],
  "Natural shrubby vegetation",      "Areas with woody vegetation associations that are unmanaged and dominated by shrubs.", ld$concept[6],
  "Palm plantations",                "Areas with woody vegetation used to produce crops that grow on palms trees.", ld$concept[7],
  ...
  "Naturally regenerating woodland", "Areas with woody vegetation associations that are managed for forestry uses and composed of trees established through natural regeneration.", ld$concept[7],
  "Planted woodland",                "Areas with woody vegetation associations that are managed for forestry uses and composed of trees established through planting and/or deliberate seeding.", ld$concept[7],
  "Agroforestry",                    "Areas with herbaceous vegetation with temporary use under woody plantations.", ld$concept[8],
  ...
  "Shifting cultivation",            "Areas with vegetation patches with temporary uses, mixed with patches that currently recuperate (usually for a longer time than the temporary use) from their previous use.", ld$concept[8],
  "Artificially vegetated land",     "Areas with a mix of herbaceous and/or woody vegetation that has no primary sector use.", ld$concept[8],
  "Undisturbed woodland",            "Areas with woody vegetation associations that are unmanaged and dominated by trees, where the ecological processes are not significantly disturbed.", ld$concept[8],
)
