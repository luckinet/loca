...
lc <- tribble(
  ...
  "BARE LAND", "Areas covered by rock, sand or bare soil that often contain only sparse life.", domain$concept[1],
...
ld <- tribble(
  ...
  "Non-Productive",          "Areas covered by human-made structures that are largely life-less.", lc$concept[2],
...
lu <- tribble(
  ...
  # "Herbaceous crops",                "Areas with managed herbaceous vegetation used for crops that need one or two years before harvest (both for human and livestock uses).", ld$concept[5],
  # "Fallow",                          "Areas with unmanaged herbaceous vegetation currently not used, with an intention for crop production within 3 years.", ld$concept[5],
  # "Anthropogenic grazingland",       "Areas with managed herbaceous vegetation used for grazing (seeding, mowing, fertilizing, fencing, grazing, etc).", ld$concept[5],
  # "Naturally growing grazingland",   "Areas with unmanaged herbaceous vegetation (with sparse woody vegetation) used for grazing.", ld$concept[5],
  # "Naturally growing grassland",     "Areas with unmanaged herbaceous vegetation that do not exist due to management but due to bio-climatic conditions (savannah, steppe, prairie, tundra, etc).", ld$concept[5],
  # "Shrub orchards",                  "Areas with managed woody vegetation used for crops that grow on shrubs.", ld$concept[6],
  # "Naturally growing shrubland",     "Areas with unmanaged woody vegetation dominated by shrubs .", ld$concept[6],
  # "Palm plantations",                "Areas with managed woody vegetation used for crops that grow on palms trees.", ld$concept[7],
  # "Tree orchards",                   "Areas with managed woody vegetation used for crops that grow on trees other than palms.", ld$concept[7],
  # "Woody plantation",                "Areas with managed woody vegetation used for wood or biomass production from even-aged trees of one or, at most two, tree species.", ld$concept[7],
  # "Naturally regenerating forest",   "Areas with managed woody vegetation used for forestry and composed of trees established through natural regeneration.", ld$concept[7],
  # "Planted forest",                  "Areas with managed woody vegetation used for forestry and composed of trees established through planting and/or deliberate seeding.", ld$concept[7],
  # "Naturally growing forest",        "Areas with unmanaged woody vegetation dominated by trees that do not exist due to management but due to bio-climatic conditions.", ld$concept[7],
  # "Mix of primary sector uses",      "Areas with managed vegetation patches of various types (temporary, permanent, pasture, agroforest, silvopastoral, shifting, etc) used for crops.", ld$concept[8],
  # "Other vegetated land",            "Areas with managed vegetation that has no primary sector use (gardens, parks, sports, etc).", ld$concept[8],
  ...
  "Mix of primary sector uses",      "Areas with vegetation patches of various types (agroforestry, silvopastoral, shifting, etc) used for primary sector products.", ld$concept[5],
  "Other vegetated land",            "Areas with vegetation that has no primary sector use (gardens, parks, sports, etc).", ld$concept[5],
  "Naturally growing biocrust",      "Areas with a relative stable state of lichen and mosses", ld$concept[6],
  "Naturally growing grassland",     "Areas with a relative stable state of grasses and forbs.", ld$concept[6],
  "Naturally growing shrubland",     "Areas with a relative stable state of woody plants with more than one stem (shrubs).", ld$concept[6],
  "Naturally growing woodland",      "Areas with a relative stable state of woody plants with one central stem (trees).", ld$concept[6],
)
