...
useTypes <- tribble(
  ...
  "labor",        "animals that are used for labor.",
...
luckiOnto <- new_class(new = "domain", target = NA_character_,
  ...
  new_class(new = "landdynamic", target = "landcover", description = "predominant attribute determining dynamics within the landcover type", ontology = .) %>%
  new_class(new = "landuse", target = "landdynamic", description = "mutually exclusive types of how land covered by a particular type is used.", ontology = .) %>%
...
lc <- tribble(
  ...
  "BARE LAND", "Areas with no vegetation cover and no signs of any management or use of the present resources.", domain$concept[1],
  "ARTIFICIAL LAND", "Areas characterized by an artificial and often impervious cover of various structures typically managed for certain uses.", domain$concept[1],
  "VEGETATED LAND", "Areas covered by open vegetation of any kind.", domain$concept[1],
...
ld <- tribble(
  ~concept, ~description, ~broader,
  "Abiotic", "Land predominantly covered by rock, sand or bare soil that is largely life-less.", lc$concept[1],
  ...
  "Mosaic", "Land covered by a mix of vegetation life forms that are either arranged in (cyclic/shifting) patches or where several layers are dominant.", lc$concept[3],
...
lu <- tribble(
  ~concept, ~description, ~broader,
  "Artificial unvegetated land",     "Land covered by areas with little to no vegetation due to (previous) management (such as mines or dumps, etc).", ld$concept[1],
  "Natural unvegetated land",        "Land covered by areas with little to no vegetation that are unmanaged.", ld$concept[1],

  "Artificial built-up land",        "Land covered by any artificially built-up structures such as buildings, roads and rails and exluding primary sector uses.", ld$concept[2],
  "Energy production",               "Land covered by artificially built-up structures that is used for energy production and exluding primary sector uses.", ld$concept[2],

  "Agrovoltaics",                    "Land covered by solar panels or windfarms that is used in combination with plant production or livestock rearing.", ld$concept[3],
  "Artificial vegetated land",       "Land covered by any artifically vegetated areas without primary sector uses (for example for recreational use or as kitchen gardens).", ld$concept[3],
  "Protective Cover",                "Land covered by buildings that are used to produce plants, mushrooms or livestock under an artificial cover (with highly controlable conditions).", ld$concept[3],

  "Herbaceous crops",                "Land covered by temporary herbaceous vegetation that is used to produce crops for non-livestock uses.", ld$concept[5],
  "Fallow",                          "Land covered by temporary herbaceous vegetation that is used to produce crops, but where currently nothing is extracted (at most for 3 years).", ld$concept[5],
  "Temporary grazing",               "Land covered by temporary herbaceous vegetation that is used to produce crops for grazing or livestock fodder production.", ld$concept[5],
  "Managed pastures",                "Land covered by permanent herbaceous vegetation that is managed (seeded, mown, fertilized, fenced, etc) and used for grazing.", ld$concept[5],
  "Unmanaged pastures",              "Land covered by permanent herbaceous vegetation (and occasional woody vegetation) that is unmanaged but used for grazing.", ld$concept[5],
  "Natural herbaceous vegetation",   "Land covered by herbaceous vegetation associations that are unmanaged.", ld$concept[5],

  "Shrub orchards",                  "Land covered by woody vegetation that is used to produce commodities that grow on shrubs.", ld$concept[6],
  "Natural shrubby vegetation",      "Land covered by woody vegetation associations lower than 5 meters that are unmanaged.", ld$concept[6],

  "Palm plantations",                "Land covered by woody vegetation that is used to produce commodities that grow on palms trees.", ld$concept[7],
  "Tree orchards",                   "Land covered by woody vegetation that is used to produce commodities that grow on trees other than palms.", ld$concept[7],
  "Woody plantation",                "Land covered by woody vegetation that is used to produce woood or biomass from even-aged trees of one or, at most two, tree species.", ld$concept[7],
  "Naturally regenerating woodland", "Land covered by woody vegetation associations higher than 5 meters that are managed and composed of trees established through natural regeneration.", ld$concept[7],
  "Planted woodland",                "Land covered by woody vegetation associations higher than 5 meters that are managed and composed of trees established through planting and/or deliberate seeding.", ld$concept[7],
  "Temporally unstocked woodland",   "Land covered by woody vegetation associations shorter than 1.3 meters that has not yet reached but are expected to reach a tree height of at least 5 meters.", ld$concept[7],

  "Agroforestry",                    "Land covered by temporary herbaceous vegetation under trees with forestry use.", ld$concept[8],
  "Mix of agricultural uses",        "Land covered by a mix of various temporary and/or permanent crops and/or pastures on the same patch.", ld$concept[8],
  "Shifting cultivation",            "Land covered by patches that are temporally used, mixed with patches that currently recuperate (usually for a longer time) from their previous use.", ld$concept[8],
  "Undisturbed woodland",            "Land covered by woody vegetation associations higher than 5 meters that are unmanaged, where the ecological processes are not significantly disturbed.", ld$concept[8],
)
...
group <- tribble(
  ...
  "VEGETABLES", "This group comprises plants that are grown primarily to use some of their organs (includes typically savory fruit, but not seeds) that are often heated to be easily digestible.", domain$concept[2],
...
class <- tribble(
  ...
  "Pasture and forage crops", "This class covers plants that are grown as food source for animals, to produce fodder/silage or to be grazed on by livestock.", group$concept[1],
  ...
  "Oleaginous fruits", "This calss covers plants that are grown for their oil-containing tissue.", group$concept[2],
...
# | purpose       | character | the type of use for the crop/animal |
# | used_part     | character | the part of the crop/animal that is used |
...
bioenergy <-
  tibble(concept = "bamboo", broader = class$concept[1], scientific = "Bambusa spp.",
         ...
         purpose = useTypes$label[1], used_part = usedParts$label[3], life_form = lifeForms$label[1],
...
bioenergy <-
  tibble(concept = "acacia", broader = class$concept[1], scientific = "Acacia spp.",
         ...
         purpose = useTypes$label[1], used_part = usedParts$label[3], life_form = lifeForms$label[2],
...
fibre <-
  tibble(concept = "jute", broader = class$concept[2], scientific = "Corchorus spp.",
         ...
         purpose = useTypes$label[2], used_part = usedParts$label[2], life_form = lifeForms$label[5],
...
fibre <-
  tibble(concept = "abaca|manila hemp", broader = class$concept[2], scientific = "Musa textilis",
         ...
         purpose = useTypes$label[2], used_part = usedParts$label[13], life_form = lifeForms$label[2],
...
fibre <-
  tibble(concept = "kapok", broader = class$concept[2], scientific = "Ceiba pentandra",
         ...
         purpose = paste0(useTypes$label[c(2, 3)], collapse = "|"), used_part = usedParts$label[20], life_form = lifeForms$label[2],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(fibre, .)
...
fibre <-
  tibble(concept = "new zealand flax|formio", broader = class$concept[2], scientific = "Phormium tenax",
         ...
         purpose = useTypes$label[2], used_part = usedParts$label[23], life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(fibre, .)
...
fibre <-
  tibble(concept = "fique", broader = class$concept[2], scientific = "Furcraea macrophylla",
         ...
         purpose = useTypes$label[2], used_part = usedParts$label[13], life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(fibre, .)
...
fibre <-
  tibble(concept = "henequen", broader = class$concept[2], scientific = "Agave fourcroydes",
         ...
         purpose = useTypes$label[2], used_part = paste0(usedParts$label[c(8, 13)], collapse = "|"), life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(fibre, .)
...
rubber <-
  tibble(concept = "natural rubber", broader = class$concept[4], scientific = "Hevea brasiliensis",
         ...
         purpose = useTypes$label[8], used_part = usedParts$label[17], life_form = lifeForms$label[2],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA)
...
pasture <-
  tibble(concept = "alfalfa", broader = class$concept[5], scientific = "Medicago sativa",
         ...
         purpose = paste0(useTypes$label[c(3, 5, 7)], collapse = "|"), used_part = usedParts$label[3], life_form = lifeForms$label[1],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA)
...
pasture <-
  tibble(concept = "orchard grass", broader = class$concept[5], scientific = "Dactylis glomerata",
         ...
         purpose = paste0(useTypes$label[c(5, 7)], collapse = "|"), used_part = usedParts$label[3], life_form = lifeForms$label[1],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(pasture, .)
...
pasture <-
  tibble(concept = "redtop", broader = class$concept[5], scientific = "Agrostis spp.",
         ...
         purpose = useTypes$label[5], used_part = usedParts$label[3], life_form = lifeForms$label[1],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(pasture, .)
...
pasture <-
  tibble(concept = "sudan grass", broader = class$concept[5], scientific = "Sorghum × drummondii",
         ...
         purpose = paste0(useTypes$label[c(1, 7)], collapse = "|"), used_part = usedParts$label[3], life_form = lifeForms$label[1],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(pasture, .)
...
pasture <-
  tibble(concept = "timothy", broader = class$concept[5], scientific = "Phleum pratense",
         ...
         purpose = useTypes$label[7], used_part = usedParts$label[3], life_form = lifeForms$label[1],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(pasture, .)
...
pasture <-
  tibble(concept = "clover", broader = class$concept[5], scientific = "Trifolium spp.",
         ...
         purpose = paste0(useTypes$label[c(5, 7)], collapse = "|"), used_part = usedParts$label[3], life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(pasture, .)
...
pasture <-
  tibble(concept = "lupin", broader = class$concept[5], scientific = "Lupinus spp.",
         ...
         purpose = paste0(useTypes$label[c(3, 5, 7)], collapse = "|"), used_part = usedParts$label[3], life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(pasture, .)
...
berries <-
  tibble(concept = "blueberry", broader = class$concept[6], scientific = "Vaccinium myrtillus|Vaccinium corymbosum",
         ...
         purpose = useTypes$label[3], used_part = usedParts$label[9], life_form = lifeForms$label[4],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA)
...
citrus <-
  tibble(concept = "bergamot", broader = class$concept[7], scientific = "Citrus bergamia",
         ...
         purpose = useTypes$label[3], used_part = usedParts$label[9], life_form = lifeForms$label[2],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA)
...
oleaginous <-
  tibble(concept = "coconut", broader = class$concept[11], scientific = "Cocos nucifera",
         ...
         purpose = paste0(useTypes$label[c(2, 3)], collapse = "|"), used_part = usedParts$label[20], life_form = lifeForms$label[3],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA)
...
oleaginous <-
  tibble(concept = "oil palm", broader = class$concept[11], scientific = "Elaeis guineensis",
         ...
         purpose = useTypes$label[3], used_part = usedParts$label[20], life_form = lifeForms$label[3],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
...
tropical <-
  tibble(concept = "banana", broader = class$concept[12], scientific = "Musa sapientum|Musa cavendishii|Musa nana",
         ...
         purpose = paste0(useTypes$label[c(2, 3)], collapse = "|"), used_part = paste0(usedParts$label[c(9, 13)], collapse = "|"), life_form = lifeForms$label[2],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(tropical, .)
...
tropical <-
  tibble(concept = "açaí", broader = class$concept[12], scientific = "Euterpe oleracea",
         ...
         purpose = useTypes$label[3], used_part = usedParts$label[9], life_form = lifeForms$label[3],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(tropical, .)
...
cereals <-
  tibble(concept = "barley", broader = class$concept[13], scientific = "Hordeum vulgare",
         ...
         purpose = paste0(useTypes$label[c(3, 5)], collapse = "|"), used_part = usedParts$label[20], life_form = lifeForms$label[1],
...
cereals <-
  tibble(concept = "maize", broader = class$concept[13], scientific = "Zea mays",
         ...
         purpose = paste0(useTypes$label[c(3, 6)], collapse = "|"), used_part = usedParts$label[20], life_form = lifeForms$label[1],
         ybh = "0", yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(cereals, .)
...
cereals <-
  tibble(concept = "pearl millet", broader = class$concept[13], scientific = "Cenchrus americanus",
         ...
         purpose = useTypes$label[3], used_part = usedParts$label[20], life_form = lifeForms$label[1],
         ybh = "0", yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(cereals, .)
...
cereals <-
  tibble(concept = "oat", broader = class$concept[13], scientific = "Avena sativa",
         ...
         purpose = paste0(useTypes$label[c(3, 7)], collapse = "|"), used_part = usedParts$label[20], life_form = lifeForms$label[1],
         ybh = "0", yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(cereals, .)
...
legumes <-
  tibble(concept = "vetch", broader = class$concept[14], scientific = "Vicia sativa",
         ...
         purpose = paste0(useTypes$label[c(3, 7)], collapse = "|"), used_part = usedParts$label[20], life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(legumes, .)
...
legumes <-
  tibble(concept = "carob", broader = class$concept[14], scientific = "Ceratonia siliqua",
         ...
         purpose = useTypes$label[3], used_part = usedParts$label[20], life_form = lifeForms$label[2],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(legumes, .)
...
oilseeds <-
  tibble(concept = "castor bean", broader = class$concept[16], scientific = "Ricinus communis",
         ...
         purpose = paste0(useTypes$label[c(3, 10)], collapse = "|"), used_part = usedParts$label[20], life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA)
...
oilseeds <-
  tibble(concept = "cotton", broader = class$concept[16], scientific = "Gossypium spp.",
         ...
         purpose = paste0(useTypes$label[c(2, 3)], collapse = "|"), used_part = usedParts$label[9], life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(oilseeds, .)
...
oilseeds <-
  tibble(concept = "earth pea", broader = class$concept[16], scientific = "Vigna subterranea",
         ...
         purpose = useTypes$label[3], used_part = usedParts$label[9], life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(oilseeds, .)
...
oilseeds <-
  tibble(concept = "fenugreek", broader = class$concept[16], scientific = "Trigonella foenum-graecum",
         ...
         purpose = useTypes$label[3], used_part = paste0(usedParts$label[c(13, 20)], collapse = "|"), life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(oilseeds, .)
...
oilseeds <-
  tibble(concept = "hemp", broader = class$concept[16], scientific = "Canabis sativa",
         ...
         purpose = paste0(useTypes$label[c(2, 3)], collapse = "|"), used_part = usedParts$label[20], life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(oilseeds, .)
...
oilseeds <-
  tibble(concept = "linseed", broader = class$concept[16], scientific = "Linum usitatissimum",
         ...
         purpose = paste0(useTypes$label[c(2, 3, 8)], collapse = "|"), used_part = usedParts$label[20], life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(oilseeds, .)
...
oilseeds <-
  tibble(concept = "jojoba", broader = class$concept[16], scientific = "Simmondsia chinensis",
         ...
         purpose = useTypes$label[3], used_part = paste0(usedParts$label[c(2, 20)], collapse = "|"), life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(oilseeds, .)
...
oilseeds <-
  tibble(concept = "poppy", broader = class$concept[16], scientific = "Papaver somniferum",
         ...
         purpose = paste0(useTypes$label[c(3, 9, 10)], collapse = "|"), used_part = usedParts$label[20], life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(oilseeds, .)
...
oilseeds <-
  tibble(concept = "safflower", broader = class$concept[16], scientific = "Carthamus tinctorius",
         ...
         purpose = paste0(useTypes$label[c(3, 8)], collapse = "|"), used_part = usedParts$label[20], life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(oilseeds, .)
...
oilseeds <-
  tibble(concept = "tallowtree", broader = class$concept[16], scientific = "Shorea aptera|Shorea stenocarpa|Sapium sebiferum",
         ...
         purpose = useTypes$label[8], used_part = usedParts$label[20], life_form = lifeForms$label[2],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(oilseeds, .)
...
stimulants <-
  tibble(concept = "tobacco", broader = class$concept[17], scientific = "Nicotiana tabacum",
         ...
         purpose = useTypes$label[9], used_part = usedParts$label[13], life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA)
...
stimulants <-
  tibble(concept = "cocoa|cacao", broader = class$concept[17], scientific = "Theobroma cacao",
         ...
         purpose = paste0(useTypes$label[c(3, 9)], collapse = "|"), used_part = usedParts$label[20], life_form = lifeForms$label[2],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
...
stimulants <-
  tibble(concept = "coffee", broader = class$concept[17], scientific = "Coffea spp.",
         ...
         purpose = paste0(useTypes$label[c(3, 9)], collapse = "|"), used_part = usedParts$label[9], life_form = lifeForms$label[4],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(stimulants, .)
...
stimulants <-
  tibble(concept = "mate", broader = class$concept[17], scientific = "Ilex paraguariensis",
         ...
         purpose = paste0(useTypes$label[c(3, 9)], collapse = "|"), used_part = usedParts$label[13], life_form = lifeForms$label[4],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(stimulants, .)
...
spice <-
  tibble(concept = "cannella cinnamon", broader = class$concept[18], scientific = "Cinnamomum verum",
         ...
         purpose = paste0(useTypes$label[c(3, 10)], collapse = "|"), used_part = usedParts$label[1], life_form = lifeForms$label[2],
...
spice <-
  tibble(concept = "chillies and peppers", broader = class$concept[18], scientific = "Capsicum spp.",
         ...
         purpose = paste0(useTypes$label[c(3, 10)], collapse = "|"), used_part = usedParts$label[9], life_form = lifeForms$label[5],
...
spice <-
  tibble(concept = "fennel", broader = class$concept[18], scientific = "Foeniculum vulgare",
         ...
         purpose = useTypes$label[3], used_part = paste0(usedParts$label[c(5, 9, 13)], collapse = "|"), life_form = lifeForms$label[5],
         ybh = "0", yoh = "1", harvests = "1",  yield_min = NA, yield_max = NA, height = "2") %>%
  bind_rows(spice, .)
...
spice <-
  tibble(concept = "hop", broader = class$concept[18], scientific = "Humulus lupulus",
         ...
         purpose = useTypes$label[3], used_part = usedParts$label[7], life_form = lifeForms$label[6],
...
spice <-
  tibble(concept = "ginger", broader = class$concept[18], scientific = "Zingiber officinale",
         ...
         purpose = useTypes$label[3], used_part = usedParts$label[18], life_form = lifeForms$label[5],
...
spice <-
  tibble(concept = "vanilla", broader = class$concept[18], scientific = "Vanilla planifolia",
         ...
         purpose = useTypes$label[3], used_part = usedParts$label[9], life_form = lifeForms$label[6],
...
spice <-
  tibble(concept = "lavender", broader = class$concept[18], scientific = "Lavandula spp.",
         ...
         purpose = useTypes$label[3], used_part = paste0(usedParts$label[c(4, 13)], collapse = "|"), life_form = lifeForms$label[5],
         ybh = "0", yoh = "1", harvests = "1",  yield_min = NA, yield_max = NA, height = "1") %>%
  bind_rows(spice, .)
...
spice <-
  tibble(concept = "angelica", broader = class$concept[18], scientific = "Angelica archangelica",
         ...
         purpose = paste0(useTypes$label[c(3, 10)], collapse = "|"), used_part = usedParts$label[21], life_form = lifeForms$label[5],
...
spice <-
  tibble(concept = "bay leaves", broader = class$concept[18], scientific = "Laurus nobilis",
         ...
         purpose = paste0(useTypes$label[c(3, 10)], collapse = "|"), used_part = usedParts$label[13], life_form = lifeForms$label[2],
...
spice <-
  tibble(concept = "saffron", broader = class$concept[18], scientific = "Crocus sativus",
         ...
         purpose = useTypes$label[3], used_part = usedParts$label[7], life_form = lifeForms$label[5],
         ybh = "0", yoh = "1", harvests = "1",  yield_min = NA, yield_max = NA, height = "0.5") %>%
  bind_rows(spice, .)
...
spice <-
  tibble(concept = "turmeric", broader = class$concept[18], scientific = "Curcuma longa",
         ...
         purpose = paste0(useTypes$label[c(3, 10)], collapse = "|"), used_part = usedParts$label[18], life_form = lifeForms$label[5],
         ybh = "0", yoh = "1", harvests = "1",  yield_min = NA, yield_max = NA, height = "1") %>%
  bind_rows(spice, .)
...
spice <-
  tibble(concept = "clove", broader = class$concept[18], scientific = "Eugenia aromatica",
         ...
         purpose = useTypes$label[3], used_part = usedParts$label[7], life_form = lifeForms$label[2],
...
medicinal <-
  tibble(concept = "basil", broader = class$concept[19], scientific = "Ocimum basilicum",
         ...
         purpose = useTypes$label[3], used_part = usedParts$label[13], life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA)
...
medicinal <-
  tibble(concept = "guarana", broader = class$concept[19], scientific = "Paulinia cupana",
         ...
         purpose = paste0(useTypes$label[c(3, 9)], collapse = "|"), used_part = usedParts$label[20], life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(medicinal, .)
...
medicinal <-
  tibble(concept = "coca", broader = class$concept[19], scientific = "Erythroxylum novogranatense|Erythroxylum coca",
         ...
         purpose = useTypes$label[9], used_part = usedParts$label[13], life_form = lifeForms$label[2],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(medicinal, .)
...
sugar <-
  tibble(concept = "sugar beet", broader = class$concept[20], scientific = "Beta vulgaris var. altissima",
         ...
         purpose = paste0(useTypes$label[c(3, 7)], collapse = "|"), used_part = usedParts$label[18], life_form = lifeForms$label[5],
...
sugar <-
  tibble(concept = "sugar cane", broader = class$concept[20], scientific = "Saccharum officinarum",
         ...
         purpose = paste0(useTypes$label[c(3, 7)], collapse = "|"), used_part = paste0(usedParts$label[c(19, 21)], collapse = "|"), life_form = lifeForms$label[1],
...
sugar <-
  tibble(concept = "sugar maple", broader = class$concept[20], scientific = "Acer saccharum",
         ...
         purpose = useTypes$label[3], used_part = usedParts$label[19], life_form = lifeForms$label[2],
...
fruit_veg <-
  tibble(concept = "pumpkin", broader = class$concept[21], scientific = "Cucurbita spp",
         ...
         purpose = paste0(useTypes$label[c(3, 7)], collapse = "|"), used_part = usedParts$label[9], life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(fruit_veg, .)
...
leaf_veg <-
  tibble(concept = "asparagus", broader = class$concept[22], scientific = "Asparagus officinalis",
         ...
         purpose = useTypes$label[3], used_part = usedParts$label[21], life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(leaf_veg, .)
...
leaf_veg <-
  tibble(concept = "bok choy|pak choi", broader = class$concept[22], scientific = "Brassica rapa subsp. chinensis",
         ...
         purpose = paste0(useTypes$label[c(3, 7)], collapse = "|"), used_part = usedParts$label[13], life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(leaf_veg, .)
...
leaf_veg <-
  tibble(concept = "brussels sprout", broader = class$concept[22], scientific = "Brassica oleracea var. gemmifera",
         ...
         purpose = paste0(useTypes$label[c(3, 7)], collapse = "|"), used_part = usedParts$label[7], life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(leaf_veg, .)
...
leaf_veg <-
  tibble(concept = "chicory", broader = class$concept[22], scientific = "Cichorium intybus",
         ...
         purpose = paste0(useTypes$label[c(3, 9)], collapse = "|"), used_part = usedParts$label[13], life_form = lifeForms$label[5],
         ybh = NA, yoh = NA, harvests = NA,  yield_min = NA, yield_max = NA, height = NA) %>%
  bind_rows(leaf_veg, .)
...
mushrooms <-
  tibble(concept = "mushrooms", broader = class$concept[23], scientific = "Agaricus spp.|Pleurotus spp.|Volvariella",
         ...
         purpose = useTypes$label[3], used_part = usedParts$label[9], life_form = lifeForms$label[7],
...
root_veg <-
  tibble(concept = "garlic", broader = class$concept[24], scientific = "Allium sativum",
         ...
         purpose = useTypes$label[3], used_part = usedParts$label[5], life_form = lifeForms$label[5],
         ybh = "0", yoh = "1", harvests = "1",  yield_min = NA, yield_max = NA, height = "1") %>%
  bind_rows(root_veg, .)
...
root_veg <-
  tibble(concept = "mangelwurzel", broader = class$concept[24], scientific = "Beta vulgaris subsp. vulgaris crassa group",
         ...
         purpose = paste0(useTypes$label[c(3, 5)], collapse = "|"), used_part = usedParts$label[18], life_form = lifeForms$label[5],
         ybh = "0", yoh = "1", harvests = "1",  yield_min = NA, yield_max = NA, height = "0.5") %>%
  bind_rows(root_veg, .)
...
root_veg <-
  tibble(concept = "manioc|cassava|tapioca", broader = class$concept[24], scientific = "Manihot esculenta",
         ...
         purpose = paste0(useTypes$label[c(3, 7)], collapse = "|"), used_part = usedParts$label[25], life_form = lifeForms$label[4],
...
root_veg <-
  tibble(concept = "sweet potato", broader = class$concept[24], scientific = "Ipomoea batatas",
         ...
         purpose = useTypes$label[3], used_part = usedParts$label[25], life_form = lifeForms$label[5],
         ybh = "0", yoh = "1", harvests = "1",  yield_min = NA, yield_max = NA, height = "0.5") %>%
  bind_rows(root_veg, .)
...
root_veg <-
  tibble(concept = "yam", broader = class$concept[24], scientific = "Dioscorea spp.",
         ...
         purpose = useTypes$label[3], used_part = usedParts$label[25], life_form = lifeForms$label[6],
...
root_veg <-
  tibble(concept = "yautia", broader = class$concept[24], scientific = "Xanthosoma sagittifolium",
         ...
         purpose = paste0(useTypes$label[c(3, 7)], collapse = "|"), used_part = usedParts$label[25], life_form = lifeForms$label[5],
         ybh = "0", yoh = "1", harvests = "1",  yield_min = NA, yield_max = NA, height = "2") %>%
  bind_rows(root_veg, .)
...
animals <-
  tibble(concept = "partridge", broader = class$concept[25], scientific = "Alectoris rufa",
         ...
         purpose = useTypes$label[3], used_part = paste0(usedParts$label[c(6, 15)], collapse = "|"))
...
animals <-
  tibble(concept = "pigeon", broader = class$concept[25], scientific = "Columba livia",
         ...
         purpose = paste0(useTypes$label[c(3, 11)], collapse = "|"), used_part = paste0(usedParts$label[c(6, 15, 24)], collapse = "|")) %>%
  bind_rows(animals, .)
...
animals <-
  tibble(concept = "buffalo|bison", broader = class$concept[28], scientific = "Bubalus bubalus|Bubalus ami|Bubalus depressicornis|Bubalus nanus|Syncerus spp.|Bison spp.",
         ...
         purpose = paste0(useTypes$label[c(3, 11)], collapse = "|"), used_part = paste0(usedParts$label[c(15, 16, 24)], collapse = "|")) %>%
  bind_rows(animals, .)
...
animals <-
  tibble(concept = "alpaca", broader = class$concept[30], scientific = "Vicugna pacos",
         ...
         purpose= useTypes$label[2], used_part = usedParts$label[10]) %>%
  bind_rows(animals, .)
...
animals <-
  tibble(concept = "camel", broader = class$concept[30], scientific = "Camelus bactrianus|Camelus dromedarius",
         ...
         purpose = useTypes$label[11], used_part = usedParts$label[24]) %>%
  bind_rows(animals, .)
...
animals <-
  tibble(concept = "llama", broader = class$concept[30], scientific = "Lama glama",
         ...
         purpose = paste0(useTypes$label[c(2, 11)], collapse = "|"), used_part = paste0(usedParts$label[c(10, 24)], collapse = "|")) %>%
  bind_rows(animals, .)
...
animals <-
  tibble(concept = "ass", broader = class$concept[31], scientific = "Equus asinus",
         ...
         purpose = paste0(useTypes$label[c(3, 11)], collapse = "|"), used_part = paste0(usedParts$label[c(15, 24)], collapse = "|")) %>%
  bind_rows(animals, .)
...
animals <-
  tibble(concept = "beehive", broader = class$concept[34], scientific = "Apis mellifera|Apis dorsata|Apis florea|Apis indica",
         ...
         purpose = paste0(useTypes$label[c(3, 11)], collapse = "|"), used_part = paste0(usedParts$label[c(11, 24)], collapse = "|")) %>%
  bind_rows(animals, .)

animals <-
  tibble(concept = "silkmoth", broader = class$concept[34], scientific = "",
         icc_id = NA_character_, cpc_id = "", wiki_id = "", gbif_id = "",
         purpose = useTypes$label[2], used_part = usedParts$label[27]) %>%
  bind_rows(animals, .)
...
animals <-
  tibble(concept = "mink", broader = class$concept[36], scientific = "",
         icc_id = NA_character_, cpc_id = "", wiki_id = "", gbif_id = "",
         purpose = paste0(useTypes$label[2], collapse = "|"), used_part = usedParts$label[10]) %>%
  bind_rows(animals, .)
