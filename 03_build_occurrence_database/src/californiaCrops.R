...
regDataset(name = thisDataset,
           description = "",
           url = "http://atlas-dwr.opendata.arcgis.com/datasets/f4f00986f1e141cc99cff221391084de_0/data", # ideally the doi, but if it doesn't have one, the main source of the database
