...
regDataset(name = thisDataset,
           description = ,
           url = "https://doi.pangaea.de/10.1594/PANGAEA.933125",
...
# read dataset ----
#
data <- read_tsv(paste0(thisPath, "Herzschuh-etal_2021_Indopacific-meta.tab"), skip = 69)
