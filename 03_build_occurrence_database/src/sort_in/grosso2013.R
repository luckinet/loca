...
bib <- bibtex_reader(paste0(thisPath, "pericles_1537253742.bib"))
...
regDataset(name = thisDataset,
           ...
           url = "https://doi.org/10.2134/jeq2013.03.0097",
           download_date = "2017-10-17",
           type = "static",
...
# read dataset ----
#
data <- read_xlsx(paste0(thisPath, "natres.xlsx"), sheet = 2)
