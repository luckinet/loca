...
regDataset(name = thisDataset,
           ...
           url = "https://gofcgold.org/", # ideally the doi, but if it doesn't have one, the main source of the database
           download_date = "2021-11-12", # YYYY-MM-DD
           type = "static", # dynamic or static
           licence = "",
           contact = "", # optional, if it's a paper that should be "see corresponding author"
           disclosed = "no", # whether the data are freely available "yes"/"no"
           bibliography = bib,
           update = TRUE)
