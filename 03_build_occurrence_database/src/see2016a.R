...
# assertDirectoryExists(x = thisPath, access = "rw")
message("\n---- ", thisDataset, " ----")

# reference ----
#
bib <- ris_reader(paste0(thisPath, "Control_1.ris"))
...
# read dataset ----
#
data <- read_tsv(file = paste0(thisPath, "Control_1.tab"), col_types = "", skip = 17)
