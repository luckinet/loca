...
# reference ----
#
bib <- bibtex_reader(paste0(thisPath, "essd-13-1211-2021.bib"))
...
regDataset(name = thisDataset,
           ...
           url = "10.5194/essd-13-1211-2021, https://zenodo.org/record/4473715#.YfPn9abMI2w",
...
# read dataset ----
#
data <- st_read(paste0(thisPath, "Validation_points_GlobalOilPalmLayer_2019/Validation_points_GlobalOilPalmLayer_2019.shp"))
...
newConcept(new = matches$old,
           broader = c("oil palm", "oil palm", "oil palm"),
           class = "intensity", source = thisDataset)

getConcept(label_en = matches$old) %>%
  pull(label_en) %>%
  newMapping(concept = ., external = matches$new, match = "exact",
