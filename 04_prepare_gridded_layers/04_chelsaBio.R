# ----
# title       : prepare gridded layers - CHELSA bio
# description : This script summarises rasters of all layers of the same variable into a single raster to represent the overall amount of the respective variable.
