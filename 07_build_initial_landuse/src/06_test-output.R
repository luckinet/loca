...
visualise("landcover" = mp_cover, theme = myTheme)
...
visualise("territories" = mp_ahID, theme = myTheme)
...
visualise("restricted fraction" = mp_rest, theme = myTheme)
...
visualise(mp_minLU, theme = myTheme)
visualise(mp_minLUCor, theme = myTheme)
visualise(mp_maxLU, theme = myTheme)
visualise(mp_maxLUCor, theme = myTheme)
...
visualise(mp_sws, theme = myTheme)
...
visualise(mp_swsCor, theme = myTheme)
...
visualise("all supplies" = mp_sumSwsCor, theme = myTheme)#, range = c(0, 90000))
visualise("all supplies + restricted" = mp_all, theme = myTheme)
