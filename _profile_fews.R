# ----
# title        : FEWS model profile
# version      : 1.0.0
# description  : This is the script for setting up the model profile for the FEWS test submission.
# license      : https://creativecommons.org/licenses/by-sa/4.0/
# authors      : Steffen Ehrmann, Carsten Meyer
# date         : 2024-07-10
