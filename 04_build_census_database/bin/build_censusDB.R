...
#
### global ----
source(paste0(mdl04, "src/02_fao.R"))
source(paste0(mdl04, "src/02_glw.R"))
source(paste0(mdl04, "src/02_countrystat.R"))
source(paste0(mdl04, "src/02_unodc.R"))

### regional ----
source(paste0(mdl04, "src/02_agriwanet.R"))
source(paste0(mdl04, "src/02_eurostat.R"))
...
#
### northern africa ----
source(paste0(mdl04, "src/_03_algeria.R"))
source(paste0(mdl04, "src/_03_egypt.R"))                                       CAPMAS available, not integrated
# source(paste0(mdl04, "src/_03_libya.R"))
source(paste0(mdl04, "src/_03_morocco.R"))                                     maroc-maps available, not integrated, cannabis =ignore
# source(paste0(mdl04, "src/_03_sudan.R")) wip
# source(paste0(mdl04, "src/_03_tunisia.R"))
# source(paste0(mdl04, "src/_03_westernSahara.R"))

### eastern africa ----
source(paste0(mdl04, "src/_03_burundi.R"))
# source(paste0(mdl04, "src/_03_comoros.R"))
# source(paste0(mdl04, "src/_03_djibouti.R"))
# source(paste0(mdl04, "src/_03_eritrea.R"))
source(paste0(mdl04, "src/_03_ethiopia.R"))                                    spam/worldbank/csa available, not integrated
source(paste0(mdl04, "src/_03_kenya.R"))                                       spam/agCensus available, not integrated; from coutryStat only level 1 are normalised. Level 2 and Level 3 have geometries which mach AgCensus, thus they are not normalised.
source(paste0(mdl04, "src/_03_madagascar.R"))                                  level 1, 2 and 3 are harmonised. Level 4 and 5 are not registered in the gadm gpkg.
source(paste0(mdl04, "src/_03_malawi.R"))
# source(paste0(mdl04, "src/_03_mauritius.R"))
# source(paste0(mdl04, "src/_03_mozambique.R"))
source(paste0(mdl04, "src/_03_rwanda.R"))
# source(paste0(mdl04, "src/_03_seychelles.R"))
# source(paste0(mdl04, "src/_03_somalia.R"))
# source(paste0(mdl04, "src/_03_southSudan.R"))
source(paste0(mdl04, "src/_03_uganda.R"))
source(paste0(mdl04, "src/_03_tanzania.R"))                                    One table does not have clear territories.
source(paste0(mdl04, "src/_03_zambia.R"))
source(paste0(mdl04, "src/_03_zimbabwe.R"))

### central africa ----
source(paste0(mdl04, "src/03_angola.R"))
source(paste0(mdl04, "src/_03_cameroon.R"))
# source(paste0(mdl04, "src/_03_centralAfricanRepublic.R"))
# source(paste0(mdl04, "src/_03_chad.R"))
source(paste0(mdl04, "src/_03_republicCongo.R"))
# source(paste0(mdl04, "src/_03_democraticRepublicCongo.R"))
# source(paste0(mdl04, "src/_03_equatorialGuinea.R"))
source(paste0(mdl04, "src/_03_gabon.R"))                                       Most data is harmonised. ProdCassava and prodBanana are not, because they have different geometries.
...
source(paste0(mdl04, "src/_03_namibia.R"))
# source(paste0(mdl04, "src/_03_southAfrica.R"))

### western africa ----
source(paste0(mdl04, "src/_03_benin.R"))
source(paste0(mdl04, "src/_03_burkinaFaso.R"))
# source(paste0(mdl04, "src/_03_capeVerde.R"))
source(paste0(mdl04, "src/_03_côtedivoire.R"))
source(paste0(mdl04, "src/_03_gambia.R"))
source(paste0(mdl04, "src/_03_ghana.R"))
# source(paste0(mdl04, "src/_03_guinea.R"))
source(paste0(mdl04, "src/_03_guineaBissau.R"))
# source(paste0(mdl04, "src/_03_liberia.R"))
source(paste0(mdl04, "src/_03_mali.R"))
# source(paste0(mdl04, "src/_03_mauritania.R"))
source(paste0(mdl04, "src/03_niger.R"))
source(paste0(mdl04, "src/03_nigeria.R"))
source(paste0(mdl04, "src/_03_senegal.R"))
...
source(paste0(mdl04, "src/03_haiti.R"))
...
source(paste0(mdl04, "src/_03_trinidadAndTobago.R"))                           spam available, not integrated

### southern america ----
source(paste0(mdl04, "src/03_argentina.R"))
source(paste0(mdl04, "src/03_bolivia.R"))
source(paste0(mdl04, "src/03_brazil.R"))
# source(paste0(mdl04, "src/_03_chile.R"))
source(paste0(mdl04, "src/03_colombia.R")) # only unodc so far, needs more data
# source(paste0(mdl04, "src/_03_ecuador.R"))
# source(paste0(mdl04, "src/_03_guyana.R"))
source(paste0(mdl04, "src/03_paraguay.R")) # needs more data
source(paste0(mdl04, "src/_03_peru.R")) wip
...
### eastern asia ----
source(paste0(mdl04, "src/_03_china.R")) wip
# source(paste0(mdl04, "src/_03_macao.R"))
source(paste0(mdl04, "src/_03_japan.R")) missing data on livetsock
# source(paste0(mdl04, "src/_03_mongolia.R"))
source(paste0(mdl04, "src/_03_southKorea.R"))                                  forest data missing, schemas missing
# source(paste0(mdl04, "src/_03_northKorea.R"))
source(paste0(mdl04, "src/_03_taiwan.R"))
...
# source(paste0(mdl04, "src/_03_indonesia.R")) Geometries level 3, when we have numbering system and identical names
source(paste0(mdl04, "src/_03_laos.R"))
source(paste0(mdl04, "src/_03_malaysia.R")) loads of dosm/data.giv.my/midc data available, not fully integrated
source(paste0(mdl04, "src/_03_myanmar.R"))
source(paste0(mdl04, "src/_03_philippines.R")) wip
# source(paste0(mdl04, "src/_03_singapore.R"))
source(paste0(mdl04, "src/_03_thailand.R"))                                    nso available, not integrated
# source(paste0(mdl04, "src/_03_timorLeste.R"))
# source(paste0(mdl04, "src/_03_vietnam.R"))

### southern asia ----
source(paste0(mdl04, "src/_03_afghanistan.R"))
# source(paste0(mdl04, "src/_03_bangladesh.R"))
source(paste0(mdl04, "src/_03_bhutan.R"))
...
source(paste0(mdl04, "src/_03_pakistan.R"))
# source(paste0(mdl04, "src/_03_sriLanka.R"))

### western asia ----
source(paste0(mdl04, "src/_03_turkey.R")) agCensus available, not integrated
...
# source(paste0(mdl04, "src/_03_saudiArabia.R")) loads of gas data available, not fully integrated
# source(paste0(mdl04, "src/_03_unitedArabEmirates.R"))
source(paste0(mdl04, "src/_03_yemen.R")) there may be more data available locally
# source(paste0(mdl04, "src/_03_armenia.R"))
source(paste0(mdl04, "src/_03_azerbaijan.R"))
# source(paste0(mdl04, "src/_03_georgia.R"))
source(paste0(mdl04, "src/_03_iraq.R")) loads of cso data available, not fully integrated.
# source(paste0(mdl04, "src/_03_israel.R"))
# source(paste0(mdl04, "src/_03_lebanon.R"))
# source(paste0(mdl04, "src/_03_palestine.R"))
source(paste0(mdl04, "src/_03_jordan.R")) loads of dos data available, not fully integrated
source(paste0(mdl04, "src/_03_syria.R")) requires a lot of work to extract tables (makes sense to develope an automatic routine)
...
source(paste0(mdl04, "src/_03_ukraine.R")) wip
