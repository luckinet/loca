...
#
## countrystat ----
# following table has been manually edditied: "." have been removed from values and when ever needed "0" has been added to point out the number is thousand, not hundred.
## In the original table when a number was recorder like "2.08" it means it is 2080, according to comparison with the rest of the data for that specific commodity.
schema_bdi_01 <-
...
# table has different types of forest lands, which are not distinguishable in the ontology, therefore I am taking the Total areas.
