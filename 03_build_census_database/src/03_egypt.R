...
#
# # CAPMAS
# CAPMAS geometry are not needed for the normalisation, but can be used to crreclty
# normalised the geometry names with gadm, with the help of column "VARNAME_" from
# CAPMAS
