...
if(build_crops){
  ...
  # during normalisation I wrote "ignore" for commodity "coffee and tea",
  # because in ontology I could not find term that has both Commodity "cooking
  # bananas" is translated as "banana", because the table also has "plantain" as
  # a commodity. Commodity "peanut butter" has been ignored.
