...
#
# nzstat ----
# the data is from nzstat, but nzgis, doesn't have level 1 geometry. Thats why I am putting gadm.
...
# nzgis geometry is not properly registered in stage 2. Problem with the name.
