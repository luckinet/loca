...
mask_modelregion_path <- paste0(grid_dir, "output/lucki_maskModelregion.tif")
mask_restricted_path <- paste0(grid_dir, "output/lucki_restricted_YEAR.tif")
poly_ahID1_path <- paste0(grid_dir, "temp/lucki_territories_level1.gpkg")
